...
amsterdam_boat_adventures = Attraction.new(name: 'Amsterdam Boat Adventures', location: 'Nieuwe Keizersgracht 1, 1018 DS Amsterdam', latitude: '52.365952', longitude: '4.915319', price_rating: '2')
...
westerpark = Attraction.new(name: 'Westerpark', location: 'Amsterdam, NL', latitude: '52.3875', longitude: '4.8778', price_rating: '1')
...
vondelpark = Attraction.new(name: 'Vondelpark', location: 'Amsterdam, NL', latitude: '52.3580', longitude: '4.8686', price_rating: '1')
...
rembrandtpark = Attraction.new(name: 'Rembrandtpark', location: 'Postjesweg, Amsterdam', latitude: '52.3657', longitude: '4.8403', price_rating: '1')
...
van_stapele = Attraction.new(name: 'Van Stapele', location: 'Heisteeg 4, 1012 WC Amsterdam', latitude: '52.3756', longitude: '4.8946', price_rating: '1')
...
pllek = Attraction.new(name: 'Pllek', location: 'T.T. Neveritaweg 59, 1033 WB Amsterdam', latitude: '52.4063', longitude: '4.8929', price_rating: '2')
...
oosterpark = Attraction.new(name: 'Oosterpark', location: 'Oosterpark, 1012 AA Amsterdam', latitude: '52.3608', longitude: '4.9212', price_rating: '1')
...
flevopark = Attraction.new(name: 'Flevopark', location: 'Valentijnkade, 1098 XA Amsterdam', latitude: '52.3580', longitude: '4.9423', price_rating: '1')
...
beatrixpark = Attraction.new(name: 'Beatrixpark', location: 'Diepenbrockstraat 21, 1077 VX Amsterdam', latitude: '52.3409', longitude: '4.8745', price_rating: '1')
...
noorderlicht_cafe = Attraction.new(name: 'Noorderlicht Cafe', location: 'NDSM-Plein 102, 1033 WB Amsterdam', latitude: '52.3997', longitude: '4.8959', price_rating: '2')
...
eighty_four = Restaurant.new(name: "Eighty Four", latitude: '52.361191', longitude: '4.927835', location: "Oranje-Vrijstaatkade 25, 1093 KS, Amsterdam", price_rating: 2)
...
frenzi = Restaurant.new(name: "Frenzi", latitude: '52.367745', longitude: '4.901861', location: "Zwanenburgwal 232, 1011 JH, Amsterdam", price_rating: 1)
...
tashi_deleg = Restaurant.new(name: "Tashi Deleg ", latitude: '52.363678', longitude: '4.893603', location: "Utrechtsestraat 65, 1017 VJ, Amsterdam", price_rating: 2)
...
piccolino = Restaurant.new(name: "Piccolino", latitude: '52.364503', longitude: '4.881366', location: "Lange Leidsedwarsstraat 63-65, 1017 NH, Amsterdam", price_rating: 2)
...
jack_dish = Restaurant.new(name: "Jack Dish ", latitude: '52.345686', longitude: '4.860191', location: "Stadionplein 19, 1076 CG, Amsterdam", price_rating: 1)
...
burrito = Restaurant.new(name: "Burrito", latitude: '52.372553', longitude: '4.871809', location: "De Clerqstraat 141, 1052 ND, Amsterdam", price_rating: 2)
...
la_vaca = Restaurant.new(name: "La Vaca", latitude: '52.365572', longitude: '4.895689', location: "Thorbeckeplein 11-13, 10-17 CS, Amsterdam", price_rating: 2)
...
kafe_kuyl = Restaurant.new(name: "Kafé Kuyl ", latitude: '52.366432', longitude: '4.893904', location: "Rembrandtplein 26, 1017 CV Amsterdam", price_rating: 2)
...
kagetsu = Restaurant.new(name: "Kagetsu", latitude: '52.373319', longitude: '4.882193', location: "Hartenstraat 17, 1016, Amsterdam", price_rating: 2)
...
apostrof = Restaurant.new(name: "Apostrof", latitude: '52.385898', longitude: '4.882940', location: "Planciusstraat 49, 1013 ME, Amsterdam", price_rating: 3)
